      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="text-white space-y-6">
          <div>
            ...
            <p className="text-gray-400 mb-8">We're here to help with all your rental needs. Reach out to us through any of these channels.</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">info@rental.lk</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-400">www.rental.lk</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="text-sm text-gray-400 mt-2">6°53'39.5"N 79°51'13.1"E</p>
          </div>
        </div>
